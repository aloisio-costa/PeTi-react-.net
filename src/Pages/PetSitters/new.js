...
import { createPetSitter, savePetSitterPhoto } from '../../actions/petSitters.action';
...
const PetSitterNew = () => {
    ...
    const newPetSitter = async () => {
        await createPetSitter(petSitter);
            ...
            >
                {({
                    ...
                    <Form noValidate onSubmit={handleSubmit}>
                        ...
                        <Button className="mt-2" disabled={!(isValid && dirty)} variant="primary" type="submit">
                            Submit
                        </Button>
                    </Form>
                )}
